...
# rooms = [
#  {'id': 1,'name': "Let's learn JavaScript"},
#  {'id': 2,'name': "100 Days of Python"},
#  {'id': 3,'name': "A Month of Java"},
# ]
...
def home(request):
 v = request.GET.get('h') if request.GET.get('h') != None else ''
 rooms = Room.objects.filter(
    Q(topic__name__icontains=v) |
    Q(name__icontains=v) |
